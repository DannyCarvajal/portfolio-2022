  ...
  return (
    <section className="creativeSection">
      <div className="creativeSection__descContainer">
        <p
          className="descContainer__desc"
          dangerouslySetInnerHTML={{ __html: PUZZLES_TEXT["creativity"] }}
        ></p>
      </div>
      <BehanceContact />
      <PianoIndications
        turn={turn}
        level={level}
        playPianoHandler={playPianoHandler}
      />
      <Piano
        pianoGuess={pianoKeyHandler}
        notePlayingInMelody={notePlayingInMelody}
      />
      <CheckSecretWord
        solved={turn === "Melody solved"}
        letter="ig"
        bgColor="PIANO"
      />
      <SecretWord
        secretLetter={!isDesktop ? "ig" : ""}
        bgcolor={COLORS["PIANO"]}
        letterColor="white"
        animation=""
      />
    </section>
